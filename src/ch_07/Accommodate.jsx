...
· 훅
    - 훅이란?
      ...
      클래스형 컴포넌트의 단점(어려운 문법, 축소가 어려움, 로직 재사용의 어려움, 최신 기술의 적용이 효과적이지 않음)이 있지만
      state나 생명주기 함수 사용하기 위해서는 클래스형 컴포넌트를 사용했어야 했음 
      함수형 컴포넌트는 state, 생명주기 함수를 사용하지 못함 이를 해결하기 위해 훅이 등장
